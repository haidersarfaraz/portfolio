...
const Contact = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] gap-6 mt-10 mb-8'>
        ...
        <button type='submit' className='w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full py-3 px-8 mx-auto  hover:bg-black duration-500 cursor-pointer dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit <Image src={assets.right_arrow_white} alt='right arrow' className='w-4'/></button>
