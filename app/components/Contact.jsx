...
const Contact = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <button type='submit' className='w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full py-3 px-8 mx-auto  hover:bg-black duration-500 cursor-pointer'>Submit <Image src={assets.right_arrow_white} alt='right arrow' className='w-4'/></button>
